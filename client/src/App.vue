<template>
  <div class="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors">
    ...
    <div class="md:hidden bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-2">
      <select
        v-model="currentView"
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <template v-else>
        ...
        <!-- List View -->
        <div v-else-if="currentView === 'list'" class="bg-white dark:bg-gray-800 rounded-xl shadow overflow-hidden">
          <table class="w-full">
        ...
        <!-- Calendar View -->
        <div v-else-if="currentView === 'calendar'" class="bg-white dark:bg-gray-800 rounded-xl shadow p-4">
          <CalendarView :tasks="filteredTasks" :locale="locale" :t="t" @edit="openTaskForm" />
        </div>

        <!-- Timeline View -->
        <div v-else-if="currentView === 'timeline'" class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
